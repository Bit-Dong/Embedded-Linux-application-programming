...
/* An "index" thread to increment a counter 增加计数器的“索引”线程*/
void idx_th(void *arg);

/* A "monitor" thread to check the counter's value 检查计数器值的“监视器”线程*/
...
int main (int argc, char *argv[])
{
    ...
    end_time = time(NULL) + 30; /* 30 second runtime 30秒运行时*/
